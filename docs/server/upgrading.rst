...
.. warning::
   ...
   Pootle 3.0 or newer requires **Python 3.7 or later**

   If you are upgrading from Pootle 2.x which used Python 2.7, you **must** 
   upgrade or rebuild your virtual environment with Python 3.7+ first.
